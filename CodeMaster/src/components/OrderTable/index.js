...
const Rows = [
  createData(1, "maça", "23/11/2023", 40, 20, "Alimentos", "algo", 1, 1),
];
  ...
  return (
    <ThemeProvider theme={theme}>
      ...
      >
        ...
        <FormControl size="small" title="Categoria">
          ...
          >
            ...
            <MenuItem value={10}>Limpeza</MenuItem>
            <MenuItem value={20}>Alimentos</MenuItem>
            <MenuItem value={30}>Materias Escolares</MenuItem>
          </Select>
        </FormControl>
      </Toolbar>
    </ThemeProvider>
